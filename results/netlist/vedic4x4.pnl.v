module vedic4x4 (VPWR,
 ...
 sky130_fd_sc_hd__and4_1 _051_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a22o_1 _052_ (.A1(net2),
    .A2(net6),
    .B1(net3),
    .B2(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__and2b_1 _053_ (.A_N(_003_),
    .B(_004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__xnor2_1 _054_ (.A(_002_),
    .B(_005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__and2_1 _055_ (.A(_001_),
    .B(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _059_ (.A(net6),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__a22oi_1 _060_ (.A1(net3),
    .A2(net7),
    .B1(net4),
    .B2(net6),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__nor2_1 _061_ (.A(_010_),
    .B(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _062_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a22o_1 _063_ (.A1(net6),
    .A2(net3),
    .B1(net4),
    .B2(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__nand4_1 _064_ (.A(net5),
    .B(net6),
    .C(net3),
    .D(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__a21boi_1 _065_ (.A1(_013_),
    .A2(_014_),
    .B1_N(_015_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__xnor2_1 _066_ (.A(_012_),
    .B(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__xnor2_1 _067_ (.A(_009_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _068_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__nand3_1 _069_ (.A(_015_),
    .B(_013_),
    .C(_014_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__a21o_1 _070_ (.A1(_015_),
    .A2(_014_),
    .B1(_013_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _071_ (.A1(net1),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__a21oi_1 _072_ (.A1(_020_),
    .A2(_021_),
    .B1(_022_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__and3_1 _073_ (.A(_020_),
    .B(_022_),
    .C(_021_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__o21bai_1 _074_ (.A1(_019_),
    .A2(_023_),
    .B1_N(_024_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__xor2_1 _075_ (.A(_018_),
    .B(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__or3_1 _076_ (.A(_024_),
    .B(_019_),
    .C(_023_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__o21ai_1 _077_ (.A1(_024_),
    .A2(_023_),
    .B1(_019_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__and3_1 _078_ (.A(_007_),
    .B(_027_),
    .C(_028_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__xor2_1 _079_ (.A(_026_),
    .B(_029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__or3_1 _080_ (.A(_010_),
    .B(_011_),
    .C(_016_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__or2b_1 _081_ (.A(_009_),
    .B_N(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__nand2_1 _082_ (.A(net6),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _084_ (.A(net3),
    ...
    .VPWR(VPWR),
    .Y(_034_));
 sky130_fd_sc_hd__xor2_1 _085_ (.A(_033_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__and3_1 _086_ (.A(_030_),
    .B(_031_),
    .C(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__a21o_1 _087_ (.A1(_030_),
    .A2(_031_),
    .B1(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__or2b_1 _088_ (.A(_036_),
    .B_N(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__nand2_1 _089_ (.A(_018_),
    .B(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__a21bo_1 _090_ (.A1(_026_),
    .A2(_029_),
    .B1_N(_039_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _093_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__mux2_1 _094_ (.A0(_041_),
    .A1(_010_),
    .S(_042_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__o21ai_1 _095_ (.A1(_039_),
    .A2(_036_),
    .B1(_037_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__xor2_1 _096_ (.A(_043_),
    .B(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__nand2_1 _097_ (.A(_027_),
    .B(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__xnor2_1 _098_ (.A(_007_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net12));
 sky130_fd_sc_hd__a2bb2o_1 _099_ (.A1_N(_041_),
    .A2_N(_042_),
    .B1(_043_),
    .B2(_044_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__and2_1 _100_ (.A(net5),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
